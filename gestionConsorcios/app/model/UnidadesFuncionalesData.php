...
class UnidadesFuncionalesData extends Database{
    
    var $tabla = 'unidades_funcionales';
    ...
    public function sucursal_asignada($user_id){ // Buscar sucursales asignadas al usuario
     ...
     public function get_by_id($id){ // Buscar unidades por empresa administradora
    $sql = "SELECT * FROM `unidades_funcionales` WHERE `id_empresa_administradora` = '$id' ";
    $data = $this->query($sql);
...
public function get_unidad_by_id($id){ // Buscar unidades por empresa administradora
    $sql = "SELECT * FROM `unidades_funcionales` WHERE `id` = '$id' ";
     $data = $this->query($sql);
