...
class GastosData extends Database{
    ...
    public function sucursal_asignada($user_id){ // Buscar sucursales asignadas al usuario
        ...
        **/
        ...
        public function get_by_id($id){ // Buscar sucursales asignadas al usuario
        /**
        * $id = Id de la caja o el Hash asignado
        **/
        $sql = "SELECT * FROM `personas` WHERE `id_empresa_administradora` = '$id' ";
        // echo $sql; exit();
     $data = $this->query($sql);
...
public function get_persona_by_id($id){ // Buscar sucursales asignadas al usuario
        /**
        * $id = Id de la caja o el Hash asignado
        **/
        $sql = "SELECT * FROM `gastos` WHERE `id_empresa_administradora` = '$id' ";
        // echo $sql; exit();
      $data = $this->query($sql);
